                        ...
                        <MDBBtn className='shadow-5' color='light'>
                            <figure className='figure'>
                                <img
                                    ...
                                    className='figure-img rounded mx-5 my-5'
                                    alt='...'
                                    onClick={() => [navigate('/cadastroadmininastro')]}
                                />
                            </figure>
                        </MDBBtn>
                    </div>
...
//                     <div id='div1' className='col col-sm-12 col-md-6 align-items-center justify-content-center'>
//                         <h5>controle de usuários</h5>
//                         <MDBBtn className='shadow-5' color='light'>
//                             <figure className='figure'>
//                                 <img
...
//                         <div id='div2' className='col col-sm-12 col-md-6 align-items-center justify-content-center'>
//                             <h5>dashboard</h5>
//                             <MDBBtn className='shadow-5' color='light'>
//                                 <figure className='figure'>
//                                     <img
...
//                         <div id='div3' className='col col-sm-12 col-md-6 align-items-center justify-content-center'>
//                             <h5>Cadastrar Usuário</h5>
//                             <MDBBtn className='shadow-5' color='light'>
//                                 <figure className='figure'>
//                                     <img
